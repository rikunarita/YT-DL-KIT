...
# Ensure package imports work when running from the backend directory
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(BASE_DIR)
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)

from backend.database import init_db, get_db, GlobalSettingsDB, SessionLocal
...
# 後で API ルーターをインクルード
from backend.api import downloads, profiles, history, settings, scheduler
